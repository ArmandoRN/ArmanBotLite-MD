...
let pp = await conn.profilePictureUrl(who, 'image').catch(_ => ArmandoMenu.getRandom())
...
• \`\`\`${sn}\`\`\``.trim()
await conn.sendFile(m.chat, ArmandoImg.getRandom(), 'Armando.jpg', caption, m, false, { mentions: [aa] }) 
